...
// *****************************************************************************
  ...
  function wise_login_LoginRequired(){
   ...
   if($cmd==$WISE_LOGIN_CMD_LOGOUT){
      ...
      if($WISE_LOGIN_LOGOUT_GROUP!="") wise_setGroup($WISE_LOGIN_LOGOUT_GROUP);
      if($WISE_LOGIN_LOGOUT_TYPE!="")  wise_setType ($WISE_LOGIN_LOGOUT_TYPE);
      if($WISE_LOGIN_LOGOUT_PAGE!="")  wise_setPage ($WISE_LOGIN_LOGOUT_PAGE);
